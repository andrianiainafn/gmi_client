...
const NotificationContainer = (props:Props) => {
    ...
    <>
        {
            isShow && (
                <div className="bg-white shadow-sm border-[1px] border-gray-200 dark:border-none dark:bg-gray-950 z-20 p-2 rounded-lg h-[80vh] overflow-y-scroll flex flex-col space-y-3 bottom-5  w-[25vw] absolute top-[10vh] right-0">
